...
def retrieve_skill_matches(memory_db, app_id: str, query_subtask: str, top_k=3, min_score=0.35):
    matches = []
    app_mem = memory_db.get(app_id, {})
...
while True:
    ...
    if 'A' in reflect:
        ...
        # 生成/刷新“长期技能记忆”
        prompt_memory = get_memory_prompt(insight, instruction, current_app_name, current_subtask,
